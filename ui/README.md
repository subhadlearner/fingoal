# FinGoal Phase-1 UI Wireframes

This folder contains a static clickable HTML prototype for the Phase-1 MVP flow.
...
- First-time email OTP registration
- Returning-user email OTP login landing directly on dashboard
- First-time guided settings setup
- Investment capture with CAS placeholder for mutual funds
